...
public class ReceiptPrinter implements Printable {
    ...
    public ReceiptPrinter(StockTransactionDTO transaction) {
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
        ...
        if (pageIndex == 0) {
            ...
            try {
                ...
                g2d.drawString("CASH SALE RECEIPT: " + stockTransactionDTO.getSerialNumber(), 10, y);
                y += yShift;
    ...
    private static Optional<PrintService> findPrintService(String printerName) {
        ...
        System.out.println("Warning: Printer '" + printerName + "' not found. Attempting to use default printer.");
